(function (_0x59462e, _0x289a0e) {
  ...
  cmd(_0x447f24, async (_0x54d2ce, _0x41097d, _0x1ffcb9, {
    ...
    try {
      ...
      const _0x53d39a = {
        'image': _0x137a5f,
        'caption': "*_ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴀʀᴋ-ᴇᴠɪʟ ᴍᴅ_*"
      };
      const _0x3c3c7a = {
        'quoted': _0x41097d
      };
  ...
  cmd(_0x4d0d68, async (_0x456cec, _0xaf63bf, _0x3bec17, {
    ...
    try {
      const _0x1bb8c5 = "\n╭━──━─◈─━─━╮\n│🔖 *Bot Name* : 𝘿𝘼𝙍𝙆 𝙀𝙑𝙄𝙇 𝙈𝘿\n│🔖 *Owner Name* : 𝙍𝘼𝙃𝙈𝘼𝙉 𝙏𝙀𝘾𝙃\n│🔖 \n│🔖 *Prefix* : .\n│🔖 *Runtime* : _*" + hours + "h " + minutes + "m " + seconds + "s*_\n╰━━─━─◈─━─━╯";
  ...
  cmd(_0x2ae08e, async (_0x54cf97, _0x2c788a, _0x358f87, {
    ...
    try {
      ...
      if (!_0x12be33.match(/x/g)) {
        throw "*Example: " + (_0x4f14b2 + _0x4cac0e) + " 923142294xxx";
      }
  ...
  cmd(_0x8d4b85, async (_0x3eff3f, _0x21ff96, _0x1b7425, {
    ...
    try {
      if (!_0x4fed77) {
        return _0xd19ca("*👸💬 Please Give me a imoji*\nExample - ." + _0x5c5f38 + '👸');
      }
      const _0x20d2b1 = {
        'text': '✨',
        'key': _0x21ff96.key
  ...
  cmd(_0x39a5ec, async (_0xa4c156, _0xb5acf6, _0xcc330f, {
    ...
    try {
      ...
      let _0x22d8aa = "\n❍⚯────────────────────⚯❍\n        🌐  *𝚂𝙻 𝚂𝚄𝙱 𝚂𝙴𝙰𝚁𝙲𝙷 𝙻𝙸𝚂𝚃*  🌐\n ⚡ *ᴅᴀʀᴋ-ᴇᴠɪʟ ꜱʟ ꜱᴜʙᴛɪᴛʟᴇ ꜱᴇᴀʀᴄʜᴇʀ* ⚡\n❍⚯────────────────────⚯❍\n\n\n";
      ...
      await _0xa4c156.sendMessage(_0x4272db, {
        'image': _0x44889a,
        'caption': _0x22d8aa + "*_ᴅᴀʀᴋ ᴇᴠɪʟ  ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ_*\n*_ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴀʜᴍᴀɴ ᴛᴇᴄʜ_*"
      }, _0x681893);
    } catch (_0x4b6f48) {
  ...
  cmd(_0x38ec94, async (_0x5a3316, _0x4283c8, _0x5d2f57, {
    ...
    try {
      ...
      await _0x5a3316.sendMessage(_0x2da09e, {
        'image': _0x33f6d2,
        'caption': _0x196a04 + "*ᴅᴀʀᴋ ᴇᴠɪʟ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ*\n*ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴀʜᴍᴀɴ ᴛᴇᴄʜ*"
      }, _0x3e0083);
      const _0x5da3b1 = {
  ...
  cmd(_0x26db37, async (_0x5daf31, _0x366170, _0x52f6e5, {
    ...
    try {
      ...
      const _0x36f651 = "*DAEK EVIL SL SUBTITLES DOWNLOADER*\n\n📊 *Movie title - " + _0x598782.results.title + "*\n\n🔒 Creator - " + _0x598782.results.creater + "\n\n🖇️ _Link_ - " + _0x672b23 + "\n\n*ᴅᴀʀᴋ-ᴇᴠɪʟ*\n*ᴀʟʟ ʀɪɢʜᴛ ʀᴇꜱᴇʀᴠᴇᴅ - ʙʏ ʀᴀʜᴍᴀɴ ᴛᴇᴄʜ*";
      const _0x39d56d = {
        'text': _0x36f651
      };
      const _0x4858fa = {
