(function (_0x3d6483, _0x2ed406) {
  ...
  if (config.LANG === "URDU") {
    sizetoo = "_File ka size bahut ziyada hai.._ Ye phir jis platform pe main chal raha hun \n uski bandwidth boht kam hai, iss liye file upload nahi ho saki..*";
  } else {
    sizetoo = "_This file size is too big_\n *The bandwidth of the platform where this bot is hosted is not enough to upload this file!*";
  }
  const _0x43c8d7 = {
  ...
  if (config.COMMAND_TYPE === "button") {
    ...
    cmd(_0x1c4a95, async (_0x1eb185, _0x2ca636, _0x1c62c7, {
      ...
      try {
        ...
        const _0x49e75b = "*_ᴅ ᴀ ʀ ᴋ - ᴇ ᴠ ɪ ʟ_* \n\n*_s ᴏ ɴ ɢ -- ᴅ ᴏ ᴡ ɴ ʟ ᴏ ᴀ ᴅ ᴇ ʀ\n\n_*`Title` :* " + _0x5bff47.title + "\n\n> *`Size` :* " + _0x5bff47.size + "\n\n*`Duration` :* " + _0x5bff47.timestamps + "\n\n> *`Quality` :* " + _0x4b358e.quality + "\t\t\t\t   \n\n> *`O: URL` :* " + _0x5bff47.url + "\n";
        let _0x38413d = [{
          'name': "quick_reply",
    ...
    cmd(_0xc77745, async (_0x3fe280, _0xb7519, _0x13111a, {
      ...
      try {
        ...
        const _0x2f21f6 = "*𝐃 𝐀 𝐑 𝐊 - 𝐄 𝐕 𝐈 𝐋* \n\n ᴠ ɪ ᴅ ᴇ ᴏ -- ᴅ ᴏ ᴡ ɴ ʟ ᴅ ᴇ ʀ\n    \n *`ℹ️ Title` :* " + _0x13e748.title + "\n    \n *`👁️‍🗨️ Views` :* " + _0x13e748.views + "\n    \n *`🕘 Duration` :* " + _0x13e748.duration + "\n    \n *`🔗 URL` :* " + _0x13e748.url + "\n    ";
        const _0x2cd4ce = [];
